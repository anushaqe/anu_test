...
export async function navigatetoMagnusHomePage() {
  await gotoURL('https://magnus.jalatechnologies.com/');
}

export async function verifyMagnusPageURL() {
  await expectPageToHaveURL(new RegExp('https://magnus.jalatechnologies.com/'));
}
